@extends('back.app')
@section('title', 'Edit Service Page | Admin - NCG')
@section('heading', 'Edit Service Page')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Edit the Service Page Details</h4>
                <p class="text-muted mb-4 font-14">
                    Fill and submit the following form to Edit the Service Page Details.
                </p>

                <div class="row">
                    <div class="col-12">
                        <div class="p-2">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.service.update.index')}}">
                                @csrf
                                @method('patch')
                                <div class="form-group row">
                                    <label class="col-sm-2  col-form-label" for="simpleinput">Page Title</label>
                                    <div class="col-sm-10">
                                        <input name="title" required value="{{$service->title}}" type="text" id="simpleinput" class="form-control" >
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                       <img src="{{asset('storage/back/' . $service->image )}}" alt="About Image Not Available" style="width: 145px; border-radius:10px;">
                                    </div>
                                </div>
                                <a href="{{route('admin.service.index')}}" class="btn btn-outline-secondary waves-effect">Go Back</a>
