@extends('back.app')
@section('title', 'Add Business | Admin - NCG')
@section('heading', 'Add Business')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Add a Business</h4>
                <p class="text-muted mb-4 font-14">
                    Fill and submit the following form to add a Business.
                </p>

                <div class="row">
                    <div class="col-12">
                        <div class="p-2">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.business.store')}}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="relation" class="form-control">
                                            ...
                                            <option value="Group">Our Group</option>
