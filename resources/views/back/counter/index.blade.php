@extends('back.app')
@section('title', 'Edit Counter | Admin - NCG')
@section('heading', 'Edit Counter')
@php($iconsFA = array("fa-500px","fa-address-book","fa-address-book-o","fa-address-card","fa-address-card-o","fa-adjust","fa-adn","fa-align-center","fa-align-justify","fa-align-left","fa-align-right",
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Edit Counters</h4>
                <p class="text-muted mb-4 font-14">
                    Fill and submit the following form to Edit the Counters.
                </p>

                <div class="row">
                    <div class="col-12">
                        <div class="p-2">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.counter.update')}}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label">Counter 1</label>
                                        <div class="col-sm-8">
                                            <input name="c1" required value="{{$counter->c1}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label text-right">Value 1</label>
                                        <div class="col-sm-8">
                                            <input name="v1" required value="{{$counter->v1}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <span class="text-danger ml-2">{{$errors->first('c1')}}</span>
                                    <span class="text-danger ml-2">{{$errors->first('v1')}}</span>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label">Counter 2</label>
                                        <div class="col-sm-8">
                                            <input name="c2" required value="{{$counter->c2}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label text-right">Value 2</label>
                                        <div class="col-sm-8">
                                            <input name="v2" required value="{{$counter->v2}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <span class="text-danger ml-2">{{$errors->first('c2')}}</span>
                                    <span class="text-danger ml-2">{{$errors->first('v2')}}</span>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label">Counter 3</label>
                                        <div class="col-sm-8">
                                            <input name="c3" required value="{{$counter->c3}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label text-right">Value 3</label>
                                        <div class="col-sm-8">
                                            <input name="v3" required value="{{$counter->v3}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <span class="text-danger ml-2">{{$errors->first('c3')}}</span>
                                    <span class="text-danger ml-2">{{$errors->first('v3')}}</span>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label">Counter 4</label>
                                        <div class="col-sm-8">
                                            <input name="c4" required value="{{$counter->c4}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                        <label class="col-sm-4 col-form-label text-right">Value 4</label>
                                        <div class="col-sm-8">
                                            <input name="v4" required value="{{$counter->v4}}" type="text" id="simpleinput" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <span class="text-danger ml-2">{{$errors->first('c4')}}</span>
                                    <span class="text-danger ml-2">{{$errors->first('v4')}}</span>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                       <img src="{{asset('storage/back/' . $counter->image )}}" alt="counter Image Not Available" style="width: 145px; border-radius:10px;">
                                    </div>
                                </div>
